...
class SiteController extends Controller {
    ...
    public function actionIndex() {
        $menu = Menu::find()
                        ->where(['men_activo' => 1])
                        ->andWhere(['men_idPadre' => 0])
                        ->andWhere('men_id != 1')
                        ->andWhere('men_id != 19')
                        ->orderBy(['men_id' => SORT_DESC])->all();
        ...
        $menu_final = Menu::find()
                        ->where(['men_activo' => 1])
                        ->andWhere('men_id = 1 or men_id = 19')
                        ->orderBy(['men_id' => SORT_DESC])->all();
        ...
        return $this->render('index', ['solicitudes' => $solicitudes,
                    ...
                    'submenu' => $submenu,
                    'solicitudesCol' => $solicitudesCol,
                    'solicitudesArc' => $solicitudesArc]);
    }
