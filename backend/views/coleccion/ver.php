        ...
        <section class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <p>
                        <?= Html::a('<span class="glyphicon glyphicon-pencil"></span> ' .Yii::t('app', 'cambiar'), ['update', 'id' => $model->col_id], ['class' => 'btn btn-secondary']) ?>
                        ...
                        <a href="<?= Url::to(['pendientes'])?>" class="btn btn-secondary"><span class="glyphicon glyphicon-arrow-left"></span> Regresar</a>
                    </p>
                </div>
            </div>
        </section>
                ...
                echo DetailView::widget([
                    ...
                    'attributes' => [
                        [
                            ...
                            'value'=>Url::to('../../../backend/web/img/coleccion/'.$model->col_portada),
