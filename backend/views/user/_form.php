...
<div class="user-form">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <?= $form->field($model, 'use_nombre')->textInput(['autofocus' => true, 'disabled' => true]) ?>

            <?= $form->field($model, 'use_apellido')->textInput(['disabled' => true]) ?>

            <?= $form->field($model, 'uge_id')->dropDownList($genero, ['prompt' => '- Seleccionar -', 'disabled' => true]); ?>

            <?= $form->field($model, 'pai_id')->textInput()->dropDownList($pais, ['prompt' => '- Seleccionar -', 'disabled' => true]); ?>

            <?= $form->field($model, 'use_telefono')->textInput(['disabled' => true]) ?>
