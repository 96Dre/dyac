...
class Coleccion extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['col_titulo', 'col_fechaCreacion', 'col_fechaPublicacion', 'col_descripcion', 'col_fuente', 'col_estadocol', 'col_portada', 'dis_id'], 'required'],
            [['col_fechaCreacion', 'col_fechaPublicacion','col_estado'], 'safe'],
            ...
            [['col_fechaCreacion','col_accion','observacion'], 'safe'],
