...
{  
    ...
    {
        return [
            [['arc_descripcion', 'arc_ubicacion', 'arc_cita','tar_id','pai_id','idi_id','gen_id','der_id'], 'required'],
            [['col_id', 'tar_id', 'pai_id', 'gen_id', 'idi_id', 'der_id'], 'integer'],
            [['arc_fechaCreacion','arc_accion','arc_accionarc','arc_tipo', 'arc_enlace'], 'safe'],
...
//            ],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'arc_enlace' => Yii::t('app', 'Es de tipo enlace?'),
        ];
    }
