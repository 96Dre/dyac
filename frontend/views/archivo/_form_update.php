...
<div class="archivo-form">
    ...
    <?php
    $tipo_de_archivo_seleccionado = $model->tar_id;
...
//echo $controlar_tipo_archivo;
    ...
    <?php
    if (isset($tipo_de_archivo_seleccionado) && $tipo_de_archivo_seleccionado > 5) { // De otros tipos creados
        $this->registerJs("  
    function fileValidation(){
    document.getElementById('mensaje').innerHTML = '';
    var fileInput = document.getElementById('archivo-arc_archivo');
    ...
    <a href="<?= Url::to(['update_enlace?id='.$model->arc_id]) ?>" class="btn btn-secondary"><i class="bx bx-link"></i> Prefiero enlace externo</a>
