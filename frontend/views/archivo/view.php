...
$this->title = Yii::t('app', 'Archivo') . ' para "' . $c_titulo . '"';
        ...
        <section class="about" data-aos="fade-up">
            <div class="container">               
              ...
              // ***************** Tipo imagen *****************  
                ...
                <?php
                // ***************** Tipo documento *****************  
                if ($model->tar_id == 4 && $model->arc_enlace == 0) { // ***************** De tipo Documento y no es URL *****************                        
