                    ...
                    'columns' => [
                        ...
                        ['class' => 'yii\grid\ActionColumn', 'buttons' =>
                                ...
                                'cambiar' => function($url, $model, $key) {
                                    ...
                                    if ($model->col_estadocol == 'A') {
                                       $url_accion = Html::a('<span class="glyphicon glyphicon-file text-info">Archivos</span> ', $url, ['class' => 'btn', 'data' => ['method' => 'post', 'params' => ['derp' => 'herp'],], 'title' => 'Subir archivos']); //use Url::to() in order to change $url  
                                    } else { $url_accion = ""; }
                                    return $url_accion;
                                },
                            ], 'template' => '
